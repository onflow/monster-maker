...
export type MobileMenuListProps = HTMLChakraProps<"ul"> & HTMLMotionProps<"ul">

export const MotionList = motion(chakra.li)

export const NavListTransition = (props: MobileMenuListProps) => (
